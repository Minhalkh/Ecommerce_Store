    ...
    return (
        <nav className='tl-flex tl-justify-between tl-items-center tl-px-20 tl-py-5 tl-bg-gray-200 tl-w-full'>
          ...
          <ul className='tl-flex tl-gap-4 tl-items-center'>
            <Link to="/" className='tl-cursor-pointer tl-px-2 tl-h-8 hover:tl-text-rose-500 tl-flex tl-items-center'>Home</Link>
            <Link to="/about" className='tl-cursor-pointer tl-px-2 tl-h-8 hover:tl-text-rose-500 tl-flex tl-items-center'>About</Link>
